     ...
     <>
        ...
        <div className="w-[85%] mx-auto">
          <div className='flex flex-col items-center justify-center'>
            ...
            <p className='text-[rgb(22,213,255)] text-xl mb-6 text-center'>Buy, Sell And Exchange Cryptocurrency</p>
            </Fade>
            <div className='w-full'>
            <div className='lg:flex justify-between mb-4'>
            <Fade bottom>
                <div className='mt-4 w-full flex flex-col flex-start bg-white p-12 relative transition-all ease duration-500 delay-0 after:content[&quot;&quot;] after:w-0 after:h-0 after:absolute after:top-0 after:right-0 after:border-r-[8rem] after:border-r-[#F2F8FE] after:border-l-[8rem] after:border-l-transparent after:border-b-[8rem] after:border-b-transparent hover:after:border-r-[#FFF] cursor-pointer hover:transition-all'>
                    <div>
            ...
            <Fade bottom>
                <div className='mt-4 w-full flex flex-col flex-start bg-white p-12 relative transition-all ease duration-500 delay-0 after:content[&quot;&quot;] after:w-0 after:h-0 after:absolute after:top-0 after:right-0 after:border-r-[8rem] after:border-r-[#F2F8FE] after:border-l-[8rem] after:border-l-transparent after:border-b-[8rem] after:border-b-transparent hover:after:border-r-[#FFF] cursor-pointer hover:transition-all lg:mx-8'>
                    <div>
